...
export const BillingSoftwareCaseStudy: React.FC = () => {
  const project = PROJECTS.find((p) => p.id === 'billing-software') || PROJECTS[2];
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 max-w-4xl">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span className="font-mono text-xs text-[#68758F]">• {project.status}</span>
            </div>
            ...
            <p className="text-lg sm:text-2xl text-[#68758F] font-normal leading-relaxed">
              Sub-second Point-of-Sale, invoicing, and inventory software for modern merchants.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-5 sm:p-6 rounded-2xl bg-white border border-[#EAEBF0] shadow-xs">
            <div>
              <span className="font-mono text-[10px] uppercase text-[#68758F] tracking-wider block">INITIATIVE</span>
              <span className="text-sm font-semibold text-[#101828]">DEED Software Product</span>
            </div>
            <div>
              <span className="font-mono text-[10px] uppercase text-[#68758F] tracking-wider block">CATEGORY</span>
              <span className="text-sm font-semibold text-[#101828]">POS & Inventory SaaS</span>
            </div>
            <div>
              <span className="font-mono text-[10px] uppercase text-[#68758F] tracking-wider block">ARCHITECTURE</span>
              <span className="text-sm font-semibold text-[#101828]">Keyboard-First & Offline</span>
            </div>
            <div>
              <span className="font-mono text-[10px] uppercase text-[#68758F] tracking-wider block">STATUS</span>
              <span className="text-sm font-semibold text-[#315BFF]">In Active Development</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16">
          <div className="space-y-4 p-8 sm:p-10 rounded-3xl bg-white border border-[#EAEBF0] shadow-xs">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-[#101828] font-syne">
              Bloated, Crashing Legacy Billing Tools
            </h2>
          ...
          <div className="space-y-4 p-8 sm:p-10 rounded-3xl bg-white border border-[#EAEBF0] shadow-xs">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-[#101828] font-syne">
              Sub-Second Execution & Zero-Friction POS
            </h2>
            <p className="text-sm sm:text-base text-[#68758F] leading-relaxed">
              {project.approach}
            </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {project.whatWeBuilt.map((item, idx) => (
            ...
            >
              ...
              <h3 className="text-base font-bold text-[#101828] font-syne">{item}</h3>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-br from-[#DDE6FF]/50 via-white to-[#E4E2FA]/30 border border-[#DDE6FF] space-y-6 shadow-xs">
          <div className="flex items-center gap-2 text-xs font-mono text-[#315BFF] uppercase tracking-wider font-semibold">
            ...
            <span>06 // ACCESS & EARLY TESTING</span>
          </div>
          <h2 className="text-2xl sm:text-4xl font-extrabold text-[#101828] font-syne">
            Interested in Early Deployment?
          </h2>
          <p className="text-base sm:text-lg text-[#68758F] max-w-2xl leading-relaxed">
            We are partnering with select retail and food establishments to test and refine the Billing Software engine.
          </p>

          <div className="pt-2">
            <Button variant="primary" size="md" to="/contact">
              Inquire about Billing Software
            </Button>
          </div>
        </div>
      </section>
